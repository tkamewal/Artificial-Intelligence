...
try:
    ...
    chrome_driver_path = '"C:\\Users\\TANMAY KAMEWAL\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe"'
...
while True:
    ...
    if len(text) == 0:
        ...
        output_file_path = "C:\\Users\\TANMAY KAMEWAL\\PycharmProjects\\JarvisAI\\body\\SpechRecognition.txt"
